...
INSERT INTO vendas VALUES (null,4646,2,'2025-09-25');
...
SELECT *
FROM clientes
INNER JOIN endereco ON clientes.FK_endereco =endereco.idEndereco;

-- https://www.w3schools.com/mysql/mysql_join.asp

SELECT *
FROM clientes
INNER JOIN vendas ON clientes.idCliente =vendas.FK_idCliente;

SELECT c.nome, v.dataCompra
FROM clientes c
JOIN vendas v ON c.idCliente =v.FK_idCliente;
